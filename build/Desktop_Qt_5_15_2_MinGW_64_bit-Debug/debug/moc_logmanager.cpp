...
QT_MOC_LITERAL(1, 11, 15), // "logMessageAdded"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7) // "message"

    },
    "LogManager\0logMessageAdded\0\0message"
};
...
void LogManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logMessageAdded((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogManager::logMessageAdded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LogManager::logMessageAdded(const QString & _t1)
{
